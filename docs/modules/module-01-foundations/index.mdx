...
```mermaid
flowchart LR
    A["Isolated predictive model"] --> B["ML pipeline<br/>features, training, deployment, monitoring"]
    B --> C["Deep learning service<br/>GPU inference, unstructured data, specialized serving"]
    C --> D["LLM-centered system<br/>prompting, context assembly, orchestration"]
    D --> E["Tool-using and multimodal AI system<br/>retrieval, memory, APIs, policies, observability"]
```
...
<ResourceLinks
  ...
  items={[
    ...
    {label: 'Module 02 - Prompt Engineering', href: '/docs/modules/module-02-prompt-engineering-context-design'},
